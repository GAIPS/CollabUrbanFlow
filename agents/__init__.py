...
from agents.dist_ac import DistributedActorCritic as DAC
...
def load_agent(env, agent_type, chkpt_dir_path, chkpt_num, rollout_time, network):
    ...
    if agent_type == 'DAC': return DAC.load_checkpoint(chkpt_dir_path, chkpt_num), None
...
def get_agent(agent_type, env, epsilon_init, epsilon_final, epsilon_timesteps):
    ...
    if agent_type == 'DAC':
        ...
        return DAC(env.phases, adj, epsilon_init,
                    epsilon_final, epsilon_timesteps)
